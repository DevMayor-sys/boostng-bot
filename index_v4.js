...
' +
              '⚠️ Type: *' + reason + '*
' +
              '🔢 Offense count: *' + existing.count + '*
' +
              '🕐 Time: ' + new Date().toLocaleString() + '

' +
              '_This number has been permanently blacklisted._
...
' +
            '⚠️ Repeated violations may result in your WhatsApp account being *permanently banned*.

' +
            '🔒 You have been permanently blocked from this service.
...
function T_menu()     { return wm('🤖 *BOOSTNG ASSISTANT* 🤖\n_Powered by Mayor Tech Inc_ 👑\n\n━━━━━ 📋 MAIN MENU ━━━━━\n\n1️⃣  📦 SMM Services\n2️⃣  🔍 Order Status\n3️⃣  💳 Top Up Wallet\n4️⃣  📱 Virtual Numbers\n5️⃣  💰 Pricing & Bonuses\n6️⃣  🎁 Referral Program\n7️⃣  👨‍💼 Talk to Staff\n8️⃣  🔗 Links & Channels\n0️⃣  ℹ️  About BoostNG\n\n━━━━━━━━━━━━━━━━━━━━━\n💡 _Type a number or just ask!_'); }
...
function T_gchelp()   { return wm('🤖 *BoostNG Bot — Group Commands*\n\n━━━━━ 📋 COMMANDS ━━━━━\n\n*👁️ Info (Anyone):*\n!menu — This help\n!ping — Bot response\n!status — Security status\n!uptime — Bot uptime\n!info — Group details\n!link — Invite link\n!staff — Online staff\n!protect — Enable security\n\n*👑 Admin Only:*\n!add +234... — Add member\n!kick @person — Remove member\n!promote @person — Make admin\n!demote @person — Remove admin\n!setname [name] — Rename group\n!setdesc [text] — Set description\n!setpic — Set pic (reply to image)\n!everyone — Tag all members\n!revoke — Reset invite link\n\n━━━━━━━━━━━━━━━━━━━━━\n🛡️ _17-layer security • Anti-ban protected_'); }
